...
describe('JobStatus enum', () => {
  ...
  it('should have JOB_STATUS_VALUES array with all values', () => {
    expect(JOB_STATUS_VALUES.length).toBe(8);
...
describe('Column definitions', () => {
  ...
  it('should have correct column indices', () => {
    ...
    expect(COLUMN_INDEX.JOB_TITLE).toBe(4);
    expect(COLUMN_INDEX.COMPANY).toBe(5);
    expect(COLUMN_INDEX.OFFICE_LOCATION).toBe(6);
    expect(COLUMN_INDEX.WORK_TYPE).toBe(7);
